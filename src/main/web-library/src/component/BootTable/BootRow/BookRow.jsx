    ...
    if (editMode) {
      return (
        <tr key={book.id}>
          ...
          <td>
            <input
              onChange={(e) => this.updateCachedBook(
          ...
          <td>
            <DatePicker
              onChange={(date) => this.updateCachedBook(
                  {...book, releaseDate: toDateString(date)})}
          ...
          <td>
            <select
              onChange={(e) => this.updateCachedBook(
                  {...book, inPublicCatalogue: e.target.value})}
          ...
          <td>
            <button
              onClick={() => this.updateBook && this.updateBook(book)}>Save
            </button>
          </td>
        </tr>
      );
